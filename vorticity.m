...
for i = 1:100
    ...
    daspect([1 1 1])
%     colormap bone
    title(strcat('Vorticity contour at t=',num2str(dt*i,'%.3f'),' (f_e/f_0 = 1.5)'))
    xlabel('x')
    ylabel('y')
    pause(0.5)
    frame = getframe(gcf);
